...
class AniToolsSetupGui(QtWidgets.QDialog):
    ...
    def __init__(self, run_type, error_logging, close_on_success=False, testing=False):
        ...
        self.maya_tools = pyani.core.mayatoolsmngr_depr.AniMayaTools()
        ...
        # execute and start_task_list the process. Then the event loop for QT will run here and call the slot function to process
        # the output.
